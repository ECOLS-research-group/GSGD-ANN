...
def GSGD_ANN(filePath, apply_smote):
    ...
    optims = ['SGD', 'SGDM', 'ADAM', 'ADADELTA', 'RMSPROP', 'ADAGRAD']
    optim_name = optims[1]
    ...
    evaluate_algorithm(x, y, xts, yts, cache, results_container, optim_name)
...
def evaluate_algorithm(x, y, xts, yts, cache, results_container, optim_name):
    ...
    if is_guided_approach:
        ...
        for epoch in range(epochs):
            ...
            SR, E = validate(xts, network, yts, loss_function, NC)
        ...
        print_results_final(xts, network, yts, loss_function, NC, optim_name, type='guided')
        ...
        for epoch in range(epochs):
            ...
            if(epoch == epochs-1):
                print_results_final(xts, network, yts, loss_function, NC, optim_name, type='original')
